...
k3s와 vLLM을 조합하면 가벼운 LLM 서빙 환경을 구축할 수 있습니다. 이 환경을 기반으로 부하 테스트, 성능 최적화, 오토스케일링 등을 추가로 구성할 수 있습니다. 유의미한 LLM 기능을 구현하기는 힘들지만, LLM의 동작이나 내부 원리를 살펴보기에는 충분히 의미가 있는 구성입니다.
