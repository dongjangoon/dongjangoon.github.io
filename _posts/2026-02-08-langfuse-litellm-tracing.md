...
이 글에서 다룬 것은 Langfuse의 Observability 기능을 기본적으로 사용한 것에 불과합니다. Prompt Management로 코드 변경 없이 프롬프트를 배포하고, LLM-as-a-Judge로 프로덕션 트레이스의 품질을 자동 평가하며, Dataset과 Experiment로 체계적인 오프라인 테스트를 수행하는 등 활용할 수 있는 기능이 훨씬 많습니다.
